...
class MenuSpider:
    def __init__(self):
        ...
        self.db = pymysql.connect(
                                host= "", #to be complete
                                port=3306, #to be complete
                                user= "", #to be complete
                                password= "", #to be complete
                                database= "", #to be complete
                                charset='utf8')
...
#                     date, time, type, food_str, attr_str
...
#         database = "" #       to be complete
#         sql = "insert into DATABSENAME!!!." + venue + " VALUES (%s,%s,%s,%s,%s,%s);"
        try:
