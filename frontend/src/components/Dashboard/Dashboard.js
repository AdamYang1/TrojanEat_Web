        ...
        <div className="grid grid grid-cols-1 sm:grid-cols-2 gap-10">
          <div>
            ...
            <img
              ...
              alt="USC Village Dining Hall"
              src="https://hospitality.usc.edu/wp-content/uploads/2017/07/01_usc_village_dining_hall.jpg"
            />
            <div className="py-2">
          ...
          <div className="flex overflow-x-scroll">
            <div>
              <img
                ...
                alt="Everybody's Kitchen"
                src="https://hospitality.usc.edu/wp-content/uploads/2015/06/01_evk_slider.jpg"
              />
              <h1 className="text-lg font-semibold">USC Village Dining Hall</h1>
              <div className="flex">
                <StarIcon className="w-5 text-orange-300" />
